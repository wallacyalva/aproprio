                    ...
                    <div class="row">      
                        <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <form class="form-horizontal" id="cadFormCategoria" method="post" action="<?=ci_site_url("categoria/new")?>">
                                                <div class="form-group">
                                                    ...
                                                    <div class="checkbox-material">
                                                        <input type="checkbox" name="anId1" id="anId1">
                                                        <label for="anId1">Sim</label>
                                                    </div>
                                                    </div>
                                                </div>
                                                <div class="form-group" id="categoriaid">
                                                    ...
                                                    <div class="col-md-3">                   
                                                        ...
                                                        <option value="" select>Escolha a Categoria Principal</option>
                                                         <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                    <input type="text" class="form-control" name="categoria" id="categoria" placeholder="" value="" maxlength="50">
                                                ...
                                                <label class="col-md-3 control-label">É uma Categora de? <span class="required">*</span></label>
                                                    ...
                                                    <label class="radio-material">
                                                        <input id="radio3" type="radio" name="tipo" value="3">
