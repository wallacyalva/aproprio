        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <!-- START BREADCRUMB -->
                <ul class="breadcrumb">
                    <li><a href="<?=ci_site_url("categoria/new");?>">Categoria</a></li>                    
                    ...
                    <div class="row">      
                        <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <form id="editFormPlano" class="form-horizontal" method="post" action="<?=ci_site_url("plano/editar/".$this->uri->segment(3)."")?>">
                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Nome do Plano <span class="required">*</span></label>
                                                    <div class="col-md-4">
                                                    <input type="text" class="form-control" name="plano" id="plano" placeholder="" value="<?=$oneplano->plano?>" maxlength="50">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                    <input type="text" class="form-control" name="valor" id="valor" placeholder="" value="<?=$oneplano->valor?>" maxlength="50">
                                                    <span class="help-block">Example: 999.99</span>                                                    </div>
                                                </div> 
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Descrição <span class="required">*</span></label>
                                                    <div class="col-md-8">
                                                    <input type="text" class="form-control" name="descricao" id="descricao" placeholder="" value="<?=$oneplano->descricao?>" maxlength="150">
                                                         <span class="formError"></span>
                                                    </div>
                                                </div>                                                                                    
                                        </div>
