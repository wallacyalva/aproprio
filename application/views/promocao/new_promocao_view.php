        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-content-wrap">
                    <div class="row">      
                        <div class="col-md-12">
                            <form id="addFormPromocao" action="<?=ci_site_url("promocao/new");?>/<?=$this->uri->segment(3)?>"  enctype="multipart/form-data" method="post" class="form-horizontal" role="form">       
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name="title_promotion" id="title_promotion" class="form-control" value="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="price_product" id="price_product" placeholder="" value="" maxlength="7">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="price_discount" id="price_discount" placeholder="" value="" maxlength="2">
                                                         <span class="formError"></span>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="active_days" id="active_days" placeholder="" value="" maxlength="3">
                                                         <span class="formError"></span>
                                                    </div>
                                                </div>                             
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" name="product_quantity" id="product_quantity" placeholder="" value="" maxlength="4">
                                                         <span class="formError"></span>
                                                    </div>
                                                </div>                             
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                    <textarea cols="6" name="rule" id="rule" required="" rows="4" placeholder="" class="form-control"></textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                    <textarea cols="6" name="description" id="description" required="" rows="4" placeholder="" class="form-control"></textarea>
                                                ...
                                                <label class="col-md-3 control-label">&nbsp;</label>
                                                    <div class="col-md-9">
                                                        ...
                                                        <input type="file" class="fileinput btn-primary" name="file_image" id="file_image" data-filename-placement="inside" title="Escolha a Imagem da Promoção."></a>
                                                    </div>
                                            </div>
