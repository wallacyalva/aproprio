       ...
       <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-content-wrap">
                    <div class="row">      
                        <div class="col-md-12">
                            <form id="editFormCliente" action="<?=ci_site_url("relatorio/clientes");?>/<?=$this->uri->segment(3)?>" enctype="multipart/form-data" method="post" class="form-horizontal" role="form">       
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>Relatorio de Clientes <?= print_r($clientes) ?></strong></h3>
