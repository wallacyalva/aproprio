<div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">
                <a href="<?=ci_site_url()?>site/vizualizar/campanhas">
                    <h2><span class="fa fa-star"></span>Nova Campanha</h2>
                </a>
            </div>
            ...
            <div class="page-content-wrap">
                <div class="row">      
                    <div class="col-md-12">
                        <form id="addPost" action="<?=ci_site_url("site/novaCampanha")?>"  enctype="multipart/form-data" method="post" class="form-horizontal" role="form">

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Campanha</strong></h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">progresso</label>
                                        <div class="col-md-9">
                                            <input type="number" name="progresso" id="progresso" class="form-control">
                                        </div>
                                    </div>
