<div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">   
                <a href="<?=ci_site_url()?>site/vizualizar/doacoes_cabelo">
                    <h2><span class="fa fa-star"></span>Doação De Cabelo</h2>
                </a>                 
            </div>
            ...
            <div class="page-content-wrap">
                <div class="row">      
                    <div class="col-md-12">
                        <form id="addPost" action="<?=ci_site_url("site/doacaoDeCabelo")?>"  enctype="multipart/form-data" method="post" class="form-horizontal" role="form">

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Doação</strong></h3>
