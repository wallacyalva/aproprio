<div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="page-title">          
                <a href="<?=ci_site_url()?>site/vizualizar/Noticias">
                    <h2><span class="fa fa-star"></span>Criar Noticia</h2>
                </a>          
            </div>
            ...
            <div class="page-content-wrap">
                <div class="row">      
                    <div class="col-md-12">
                        <form id="addPost" action="<?=ci_site_url("site/NovaNoticia")?>"  enctype="multipart/form-data" method="post" class="form-horizontal" role="form">

                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Noticia</strong></h3>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Titulo da Noticia<span class="required">*</span></label>
                                        <div class="col-md-9">
