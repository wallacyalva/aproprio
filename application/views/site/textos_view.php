                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table datatable table-striped table-condensed table-actions">
                                    ...
                                    ?>
                                            <tr id="<?=$texto->id?>">
                                                <td><p><?=$texto->nome?></p></td>
                                                <td><p><?=$texto->texto?></p></td>
                                                <td><p><?=$texto->pagina?></p></td>
                                                <td>
                                                    <a class="btn btn-warning  btn-condensed" href="<?=ci_site_url()?>site/alterarTexto/<?=$texto->id?>"><i class="fa fa-edit"></i></a>
                                                </td>                                                    
                                            </tr>
                                    <?php
                                        }
