        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-users"></span> Meus Usuários</h2>
                </div>
                <!-- END PAGE TITLE -->
                <?php 
                                        ...
                                        <table class="table datatable table-striped table-condensed table-actions">
                                            ...
                                            ?>
                                                    <tr id="<?=$user->id?>">
                                                        ...
                                                        <td><?=$user->phone?></td>
                                                        <td>
                                                            <a href="<?=ci_site_url()?>usuario/deletar/<?=$user->id?>" class="btn btn-danger btn-condensed"><i class="fa fa-times"></i></a>
                                                            <a href="<?=ci_site_url()?>usuario/ativar/<?=$user->id?>" class="btn btn-success btn-condensed"><i class="fa fa-check"></i></a>
                                                        </td>                                                    
                                                    </tr>
                                            <?php
                                                }
