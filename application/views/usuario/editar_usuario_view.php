        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-user"></span> Editar Empreendedor</h2>
                </div>
                <!-- END PAGE TITLE -->
                <?php 
                ...
                <div class="page-content-wrap">
                    <div class="row">
                        ...
                        <form id="cadUsuaurio" name="cadUsuaurio" action="<?=ci_site_url("usuario/editar");?>/<?=$this->uri->segment(3)?>" method="post" class="form-horizontal" role="form">       
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" name="name" id="name" class="form-control" value="<?=$useEmpreendedor->name?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">E-mail</label>
                                                    <div class="col-md-10">
                                                        <input type="email" name="username_email" id="username_email" class="form-control" value="<?=$useEmpreendedor->email?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="number" name="phone" id="phone" class="form-control" value="<?=$useEmpreendedor->phone?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="number" name="zip_code" id="zip_code" class="form-control" value="<?=$useEmpreendedor->zip_code?>">
                                                    </div>
                                                </div>                                           
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Endereço</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="address" id="address" class="form-control" value="<?=$useEmpreendedor->address?>">
                                                    </div>
                                                </div>                                                                                  
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label">Bairro</label>
                                                    <div class="col-md-8">
                                                        <input type="text" name="district" id="district" class="form-control" value="<?=$useEmpreendedor->district?>">
                                                    </div>
                                                </div>                                           
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" name="city" id="city" class="form-control" value="<?=$useEmpreendedor->city?>">
                                                    </div>
                                                </div>                                           
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-2">
                                                        <input type="text" name="state" id="state" class="form-control" value="<?=$useEmpreendedor->state?>">
                                                    </div>
                                                </div>                                           
                                        </div>
                                    <div class="panel-footer">
                                        <button class="btn btn-default">Limpar</button>                                    
                                        <button class="btn btn-primary pull-right" id="criar">Atualizar</button>
                                    </div>
                                </div>
                            </form>
                        </div>
