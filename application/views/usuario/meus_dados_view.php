        ...
        <div class="page-container">
            ...
            <?php $this->load->view("template/header_menu_view", null) ?>                       
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-user"></span> Informações da Conta</h2>
                </div>
                <!-- END PAGE TITLE -->
                <?php 
                ...
                <div class="page-content-wrap">
                                ...
                                <div class="panel panel-default">                                
                                    <div class="panel-body">
                                        ...
                                        <div class="text-center" id="user_image">
                                            <img src="<?=ci_site_url("uploads/images/users/");?>/<?=$user->imagem?>" class="img-thumbnail">
                                        </div>                                    
                                    </div>
                    ...
                    <div class="col-md-9 col-sm-8 col-xs-12">
                        <form id="editDataMyUser" action="<?=ci_site_url();?>usuario/profile" method="post" class="form-horizontal" role="form">       
                                <div class="panel panel-default">
