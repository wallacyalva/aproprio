...
window.webcam = {
	...
	swf_url: '../assets/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	...
	get_html: function(width, height, server_width, server_height) {
		...
		this.set_swf_url("../assets/js/webcam.swf")
		var html = '';
	...
	snap: function(url, callback, stealth) {
		...
		var dale = this.get_movie();
		dale._snap( this.api_url, this.quality, this.shutter_sound ? 1 : 0, this.stealth ? 1 : 0 );
	},
